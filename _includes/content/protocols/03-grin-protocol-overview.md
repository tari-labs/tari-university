...
​ $ output - inputs = kernel*-excess +(part \mspace{3mu} of)kernel*- offset $
...
​ $ sum(ouputs) - sum(inputs) = sum(kernel*-excess) + kernel*-offset $
...
4. Bob computes the following:
   - message $ m = fee \Vert lock\_-height $;
...
4. Alice generates her own range proof and aggregates it with Bob, finalizing the multiparty output $ O\_{ab} $.
5. The kernel is built following the same procedure as used with [Trustless Transactions](#trustless-transactions).

We observe that the output $ O*{ab} $ is unknown to both parties, because neither knows the whole blinding factor. To be
able to build a transaction spending $ O*{ab} $, someone would need to know $ r_a + r_b $ to produce a kernel
...
[1]: https://people.xiph.org/~greg/confidential_values.txt 'Original confidential transaction paper'

[[2]] P. Robinson, H. Odendaal, S. W. van Heerden and A. Zaidelson, "Grin vs. BEAM, a Comparison", 2018 [online].
Available:&nbsp;<https://tlu.tarilabs.com/protocols/grin-vs-beam-comparison>.
Accessed: 2018&#8209;10&#8209;08.

[2]: https://tlu.tarilabs.com/protocols/grin-vs-beam-comparison 'Grin vs. BEAM, a Comparison'
...
<https://tlu.tarilabs.com/protocols/grin-design-choice-algorithms>.
Accessed: 2018&#8209;10&#8209;08.

[3]: https://tlu.tarilabs.com/protocols/grin-design-choice-algorithms 'Grin Design Choice Criticisms'
...
[4]: https://github.com/mimblewimble/grin/blob/master/doc/table_of_contents.md 'Main Grin Document Structure'
...
[5]: https://github.com/mimblewimble/grin/blob/master/doc/pruning.md 'Grin Pruning'

[[6]] I. Peverell et al., "Contracts", 2018 [online]. Available:
<https://github.com/mimblewimble/grin/blob/master/doc/contracts.md>.
Accessed: 2018&#8209;10&#8209;26.

[6]: https://github.com/mimblewimble/grin/blob/master/doc/contracts.md 'Grin Contracts'

[[7]] "Tari Labs University". Tari Labs, 2018 [online]. Available: <https://tlu.tarilabs.com/>.
Accessed: 2018&#8209;10&#8209;27.

[7]: https://tlu.tarilabs.com/ 'Tari Labs University'
...
[8]: https://github.com/mimblewimble/grin/blob/master/doc/contract_ideas.md 'Grin Contract Ideas Discussion Document'
...
[9]: https://medium.com/grinswap/first-grin-atomic-swap-a16b4cc19196 'First ever Grin atomic swap'
