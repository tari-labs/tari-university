...
| Guarantee of honest verifier  | With the standard [MPC protocol implementation](../../cryptography/bulletproofs-protocols/MainReport.md#mpc-protocol-for-bulletproofs), there's no guarantee of it being Honest Verifier Zero-knowledge (ZK), but this aspect could be improved as suggested in that report. | Similar  |
