...
| Guarantee of honest verifier  | With the standard [MPC protocol implementation](../../cryptography/bulletproofs-protocols/MainReport.md#mpc-protocol-for-bulletproofs), there's no guarantee of Honest Verifier ZK, but could be improved as suggested. | Similar  |
