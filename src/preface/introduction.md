...
*Kev, I suggest changing the format of the learning paths listed in the following sections (and as grouped in your PDF sent to me on 21 June) as follows:*

- *Create a matrix with four columns: Subject, Introductory, Intermediate, Advanced.*
- *Place a header row called 'Section' above the last three columns.*
- *List the TLU subject matter alphabetically in the first column.*
- *Insert the relevant section numbers under the last three columns.*
