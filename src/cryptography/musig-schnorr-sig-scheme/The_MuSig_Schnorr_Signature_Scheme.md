...
- [The MuSig Schnorr Signature Scheme](#the-musig-schnorr-signature-scheme)
	...
	- [Overview of Multi-Signatures](#overview-of-multi-signatures)
		...
		- [Interactive Aggregate Signatures (IAS)](#interactive-aggregate-signatures-ias)
			- [Applications of IAS](#applications-of-ias)
	...
	- [The Formation of MuSig](#the-formation-of-musig)
		...
		- [Revisions](#revisions) 
		- [Turning BN's Scheme into a Secure IAS](#turning-bns-scheme-into-a-secure-ias)
