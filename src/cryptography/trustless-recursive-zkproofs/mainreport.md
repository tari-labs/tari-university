...
A PCD achieves a trustlessness in the sense that untrusted parties carry out 
...
arithmetic circuits. The main trick is to exploiting the proof system's field structure. 
