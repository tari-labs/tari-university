...
Note: Now this is very general and a lot can be done from this. When we said T, we just threw the point over the wall and that will work and that will get you the system, but if you attaching other artillery proofs to T- or if you are doing any other complicated multiparty protocol in parallel- T is something important to the protocol, what you have got now is an adaptive signature that will let you translate correct movement of the auxiliary protocol into a valid signature. In particular of you are doing any blockchain work you can create transactions that can only be completed but correct execution of this auxiliary protocol- and this is extremely cheap to do. This is exciting - this means that any semi honest systems where there are incentive problems and you have to add a whole ton of auxiliary proofs maybe you can just stick monetary incentive for people to keep working - I am doing a multi protocol with someone-I put our some coins which they can take - I first put them in a two of two multi sig output between me and my counter party-I then do this adaptive signature protocol such that the only way that they can complete the protocol and take their coins is by revealing the secret value, which I then need for other reasons. This is a very general framework for attaching valid signatures to arbitrary discreet log based protocols and more generally any protocol where your primitives are linear-a lot of open surface for exploring this. 

---

## Atomic (Cross-chain Swaps)

- Parties Alice and Bob send points to their respective chains
